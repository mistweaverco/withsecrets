...
export const SEARCH_INDEX: SearchEntry[] = [
	...
	},
	{
		...
		excerpt:
			"How to configure withsecrets with ws.yaml, including schema, env interpolation, Parameter Store, and secret management.",
	},
	{
	...
	},
	{
		...
		excerpt:
			"Configure providers to fetch secrets from GCP Secret Manager, AWS Secrets Manager, AWS Parameter Store, Azure Key Vault, OpenBAO, Bitwarden, or local files.",
	},
	{
		title: "Examples",
		href: "/examples",
		keywords: ["examples", "param-path", "parameter store", "bulk", "*"],
