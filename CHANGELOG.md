...
- **rebrand**: kuba has been renamed to **withsecrets**. The CLI binary is now `ws` (package `withsecrets`). GitHub repository: `mistweaverco/withsecrets`. Website: [withsecrets.com](https://withsecrets.com).

### Features

- **compat**: `kuba` command, `kuba.yaml`, `~/.config/kuba/`, and `KUBA_HOME` remain supported for backwards compatibility.
...
- fix(ci): release.sh still referenced PLATFORM instead of TARGET\_\* ([277a55f](https://github.com/mistweaverco/kuba/commit/277a55f))
