...
* break: rebrand as withsecrets ([198ede6](https://github.com/mistweaverco/kuba/commit/198ede6))
* fix(ux): configuration page + navigation ([1767f77](https://github.com/mistweaverco/kuba/commit/1767f77))
* fix(web): search not working when clicking item ([84e41e0](https://github.com/mistweaverco/kuba/commit/84e41e0))
* feat(web): update docs and search index + fix searchbox race condition ([5b1a1f4](https://github.com/mistweaverco/kuba/commit/5b1a1f4))

## <small>1.11.3 (2026-05-11)</small>

* chore(docs): update changelog ([a28ea70](https://github.com/mistweaverco/kuba/commit/a28ea70))
...
* feat(tui): pre-filter regions if user config exists ([4bbf903](https://github.com/mistweaverco/kuba/commit/4bbf903))
* fix(ci): fix changelog generation in detached CI state ([6b08084](https://github.com/mistweaverco/kuba/commit/6b08084))
* fix(ci): web + changelog ([e62a5cb](https://github.com/mistweaverco/kuba/commit/e62a5cb))

## <small>1.8.3 (2026-03-26)</small>

* fix(ci): update changelog generation script ([4477e66](https://github.com/mistweaverco/kuba/commit/4477e66))

## <small>1.8.2 (2026-03-26)</small>

* fix(ci): try new apporach for changelog script ([a4cd79d](https://github.com/mistweaverco/kuba/commit/a4cd79d))

## <small>1.8.1 (2026-03-26)</small>

* chore(ci): upgrade go toolchain to version 1.26 ([f9cddcd](https://github.com/mistweaverco/kuba/commit/f9cddcd))
* chore(docs): update CHANGELOG ([0fa57f2](https://github.com/mistweaverco/kuba/commit/0fa57f2))
* fix(ci): changelog generation script ([6e5ecb0](https://github.com/mistweaverco/kuba/commit/6e5ecb0))

## 1.8.0 (2026-03-26)

* fix(ci): add depends on for build steps ([130d1f7](https://github.com/mistweaverco/kuba/commit/130d1f7))
* fix(ci): remove changelog gen step from build script ([39f3d82](https://github.com/mistweaverco/kuba/commit/39f3d82))
* fix(ci): update changelog generation script ([046a658](https://github.com/mistweaverco/kuba/commit/046a658))
